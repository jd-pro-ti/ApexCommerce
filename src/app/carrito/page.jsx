    ...
    return (
      <div className="min-h-screen bg-[#f8f9fa] pt-28 md:pt-36 pb-12 px-4 flex flex-col items-center justify-center">
        <div className="bg-white rounded-2xl shadow-sm border border-[#efedef] max-w-md w-full p-8 md:p-10 text-center">
          ...
          <Link href="/catalogo">
            <Button className="w-full !bg-[#0b1523] hover:!bg-slate-800 !text-white text-xs font-bold py-3.5 rounded-md transition-colors tracking-wide uppercase" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
              Explorar Catálogo
            </Button>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-[#efedef] max-w-md w-full p-8 md:p-10 text-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link href="/catalogo" className="w-full">
              <Button variant="outline" className="w-full border border-gray-200 text-slate-700 text-xs font-semibold py-3 rounded-md transition-all shadow-sm focus:ring-0" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Seguir Explorando
              </Button>
            </Link>
            <Link href="/dashboard/cliente/pedidos" className="w-full">
              <Button className="w-full !bg-[#0b1523] hover:!bg-slate-800 !text-white text-xs font-bold py-3 rounded-md transition-all focus:ring-0" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                Ver Pedidos
              </Button>
            </Link>
          </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-[#efedef] p-4 sm:p-8 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 mb-6 border-b border-[#efedef]">
                <div>
                  <h2 className="text-lg font-bold text-[#010f20] tracking-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                    Artículos en el Carrito
                  </h2>
                  <p className="text-xs text-[#44474c]/60 mt-0.5" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    ...
                    >
                      ...
                      <div className="flex items-start sm:items-center gap-4 w-full md:w-auto flex-1 min-w-0">
                        ...
                        <div className="space-y-1 min-w-0 flex-1">
                          ...
                          <h3 className="font-bold text-sm sm:text-base text-[#010f20] tracking-tight truncate" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                            {item.name}
                          </h3>
                          ...
                          <div className="flex flex-wrap items-center gap-3 pt-2">
                            <div className="flex items-center bg-white border border-gray-200 rounded-full px-2 py-0.5 shadow-sm">
                              <button
                                ...
                                className="w-5 h-5 text-slate-400 hover:text-slate-900 font-medium text-xs flex items-center justify-center transition-colors focus:outline-none"
                              >
                                —
                              </button>
                              <span className="w-6 text-center text-xs font-semibold text-slate-800" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                {item.quantity}
                              </span>
                              <button
                            ...
                            <button
                              ...
                              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                            >
                              <svg className="w-3.5 h-3.5 inline mr-0.5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                              </svg>
                              Eliminar
                            </button>

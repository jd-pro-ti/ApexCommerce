    ...
    <main className="min-h-screen bg-[#f8f9fa] px-6 py-16 text-[#010f20]">
      <article className="mx-auto max-w-3xl rounded-3xl bg-white p-8 shadow-sm sm:p-12">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-slate-700">
          ...
          <section><h2 className="text-lg font-bold text-[#010f20]">7. Suspensión y eliminación</h2><p>Podemos suspender cuentas que incumplan estos términos o representen un riesgo para otros usuarios. El usuario puede eliminar su cuenta desde su perfil; la acción elimina permanentemente la información personal, productos, imágenes y datos relacionados, conforme a las obligaciones legales aplicables.</p></section>

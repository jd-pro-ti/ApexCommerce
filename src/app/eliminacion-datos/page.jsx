    ...
    <main className="min-h-screen bg-[#f8f9fa] px-6 py-16 text-[#010f20]">
      <article className="mx-auto max-w-3xl rounded-3xl bg-white p-8 shadow-sm sm:p-12">
        ...
        <div className="mt-8 space-y-5 text-sm leading-7 text-slate-700">
          <p>Para solicitar la eliminación de tu cuenta y los datos asociados, inicia sesión en Apex Commerce y entra a <strong>Configuracion → Eliminar cuenta</strong>. El administrador revisará y procesará la solicitud.</p>
